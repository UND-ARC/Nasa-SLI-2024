/******** IMPORTANT: Comment out *************
  ...
  / Reset /
  write8(BNO055_SYS_TRIGGER_ADDR, 0x20); in library to work with Teensy 4.0

  This code checks for BNO055 being on, if on, it will print 30 readings of xyz data
